            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('categories.store') }}">
                        ...
                        <input class="appearance-none block w-1/3 bg-white text-gray-700 border border-solid border-gray-300 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" name="amount" placeholder="Category name" value="{{ old('name') }}">
